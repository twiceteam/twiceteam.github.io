    ...
    document.getElementById("done").addEventListener("click", function(){
        ...
        if (document.getElementById("name").value == "") { errorman("Name can't be empty");}
            ...
            codevalue.value = "<!DOCTYPE html> <html lang='en'> <head> <title>" + String(document.getElementById("name").value) + "</title>";
            ...
            var codetemp = codevalue.value;
            
            document.getElementsByTagName("body")[0].innerHTML = "<br><br><h1>Please Wait</h1>";
            ...
            $.ajax('https://pooriya007.pythonanywhere.com/links', {
                ...
                data: { pagecode: codetemp,},  // data to submit
